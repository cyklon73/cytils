...
public class WebhookOld {
/*
    private final URL webhookUrl;

    public WebhookOld(URL webhookUrl) {
        this.webhookUrl = webhookUrl;
    }

    public void send(String content, Embed embed) {
        send(content);
        send(embed);
    }

    public void send(String content, ArrayList<Embed> embeds) {
        send(content);
        send(embeds);
    }
    ...
    public void send(ArrayList<Embed> embeds) {
